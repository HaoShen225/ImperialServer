...
DEFAULT_RESULT_ROOT = PROJECT_ROOT / "TrainingData" / "WhyHD95Deterioriates_RadialGate"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Diagnose why RadialGate improves Dice but worsens HD95 by re-evaluating existing checkpoints."
    )
